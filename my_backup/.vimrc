...
Plugin 'tpope/vim-surround'	   	" Parentheses, brackets, quotes,
                                          \ XML tags, and more
Plugin 'morhetz/gruvbox'                " Цветовая схема gruvbox
...
"=====================================================
"TODO: Latex-mode settings
"=====================================================
let g:tex_flavor = 'latex'
"Отключаем автоматическое открытие окна Quickfix
let g:vimtex_quickfix_mode = 0

"Использовать zathura по умолчанию:
let g:vimtex_view_method = 'zathura'

"Включает сворачивание кода для Tex-файлов
let g:vimtex_fold_enabled = 1

"=====================================================
"TODO: Python-mode settings
"=====================================================
...
" TaskList настройки
map <F8> :TaskList<CR> 	   " отобразить список тасков на F8

" терминал
noremap <F9> :terminal<CR>
